    ...
    const handleSubmit = async (e) => {
      ...
      `;
        ...
        const prompt = `Bonjour chatGPT, tu es astrologue, tu as �t� engag� par un client pour r�pondre � ses questions sur son avenir. Voici les informations sur ton client :
                    ...
                    En t'aidant de l'analyse des �l�ments suivants peux-tu donner une interpretation pr�cise du  r�ve suivant : ${question}
                    - Son th�me astrale,
                    - Son horoscope pour l'ann�e 2023
                    ${tarotPromptAnalysis}
                    ${mbtipromptAnalysis}

                    J'aimerais que tu r�ponde pr�cis�ment et que tu donnes des exemples dans ta r�ponse. Lie chaque paragraphe avec les indications du r�ve. Finis chaque paragraphe par un conseil personnalis�s, �vite les phrases trop g�n�ralistes. Aussi dans l'astrologie les gens sont plus sensibles aux conseils qui portent sur leurs relations et l'humain que sur le mat�riel.
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="Form-Question">
                    ...
                    <input
                        ...
                        placeholder="D�crivez votre r�ve ici..."
                        required
                    />
